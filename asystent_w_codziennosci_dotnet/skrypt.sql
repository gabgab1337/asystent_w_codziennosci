...
TRUNCATE TABLE [dbo].[DonePoints];
TRUNCATE TABLE [dbo].[DoneTasks];

TRUNCATE TABLE [dbo].[TriggerPoints];
TRUNCATE TABLE [dbo].[TriggerTasks];

DELETE FROM [dbo].[TaskPoints];
DELETE FROM  [dbo].[Tasks];
DELETE FROM  [dbo].[Trigers];
...
SET IDENTITY_INSERT [dbo].[Trigers] ON 
GO

INSERT INTO [dbo].[Trigers] ( 
	[Id]
    ,[Name]
    ,[Type]
    ,[SubType]
...
SET IDENTITY_INSERT [dbo].[Trigers] OFF 
GO
...
SET IDENTITY_INSERT [dbo].[TaskPoints] ON 
GO

INSERT INTO [dbo].[TaskPoints]
           ([ID]
		   ,[Name]
           ,[Description]
           ,[MinTime]
...
SET IDENTITY_INSERT [dbo].[TaskPoints] OFF 
GO

INSERT INTO [dbo].[TriggerTasks]
           ([TaskId]
           ,[TriggerId]
		   ,[Negation])
     VALUES
